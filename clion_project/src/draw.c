...
/*{
  ...
  y0 = ((first->y - head->h / 2) PY) * cos(head->rotx) + ((first->z - head->cz) PZ) * sin(head->rotx) + (head->h / 2) PY + head->plus_h;
  z0 = ((first->z - head->cz) PZ) * cos(head->rotx) - ((first->y - head->h / 2) PY) * sin(head->rotx) + head->cz PZ;
  ...
  arr[0] = (x1 - head->width / 2) * cos(head->rotz) + (y0 - head->h / 2) * sin(head->rotz) + head->width / 2;
  arr[1] = (y0 - head->h / 2) * cos(head->rotz) - (x1 - head->width / 2) * sin(head->rotz) + head->h / 2;
  y0 = ((second->y - head->h / 2) PY) * cos(head->rotx) + ((second->z - head->cz) PZ) * sin(head->rotx) + (head->h / 2) PY + head->plus_h;
  z0 = ((second->z - head->cz) PZ) * cos(head->rotx) - ((second->y - head->h / 2) PY) * sin(head->rotx) + head->cz PZ;
  ...
  arr[2] = (x1 - head->width / 2) * cos(head->rotz) + (y0 - head->h / 2) * sin(head->rotz) + head->width / 2;
  arr[3] = (y0 - head->h / 2) * cos(head->rotz) - (x1 - head->width / 2) * sin(head->rotz) + head->h / 2;
