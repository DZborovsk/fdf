...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/08/20 09:31:19 by dzborovk          #+#    #+#             */
/*   Updated: 2018/08/20 09:46:55 by dzborovk         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static	void	ft_line(t_st fdf, t_coor c1, t_coor c2)
{
	t_coor	d;
	int		sx;
	int		sy;
...
static	void	ft_draw_img(t_st *fdf, int y, t_coor ctr)
{
	...
	while (x < fdf->w)
	{
		...
		if (x != fdf->w - 1)
			ft_line(*fdf, ft_rotate(c1, *fdf, ctr), ft_rotate(c2, *fdf, ctr));
